...
pub const WRITER: &[Tab] = &[
    ...
    // **Word's Insert tab** (2026-09-18, the owner). Order and names follow Word:
    // Pages / Tables / Illustrations / Links / Comments / Header & Footer /
    // Text / Symbols. Grey buttons are what Word has and we do not. Bookmark,
    // Cross-reference and Comment are the same buttons as in References and
    // Collaboration. The list is FIXED_ORDER in ui/gen_ribbon.py
    Tab { name: "Insert", cmds: &[
        x("Cover Page", "cover-page"),
        c("blankpage", "Blank Page", "blankpage"),
        c("pagebreak", "Page Break", "pagebreak"),
        c("instable", "Table", "instable"),
        c("insimage", "Pictures", "insertimage"),
        c("insshape", "Shapes", "insshape"),
        x("Icons", "icons"),
        c("inssmartart", "SmartArt", "inssmartart"),
        c("inschart", "Chart", "inschart"),
        ...
        c("edit-header", "Header", "edit-header"),
        c("edit-footer", "Footer", "edit-footer"),
        c("pagenum", "Page Number", "pagenum"),
        c("numpages", "Number of pages", "numpages"),
        c("instext", "Text Box", "instext"),
        x("Quick Parts", "quick-parts"),
        c("instextart", "WordArt", "instextart"),
        c("dropcap", "Drop Cap", "dropcap"),
        x("Signature Line", "form-signature"),
        c("datetime", "Date & Time", "datetime"),
        x("Object", "object"),
        c("text-from-file", "Text from File", "text-from-file"),
        c("insequation", "Equation", "insequation"),
        c("inssymbol", "Symbol", "inssymbol"),
...
pub const CALC: &[Tab] = &[
    ...
    Tab { name: "Protection", cmds: &[
        ...
        c("prot-range", "Protect Range", "protect-range"),
        c("prot-sign", "Add digital signature", "prot-sign"),
