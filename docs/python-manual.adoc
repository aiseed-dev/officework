...
The policy is *copy the API and the tests, never the implementation* (docs/sekkei/python.ja.md); the inventory is the ledger link:pysheet-gokan.ja.md[docs/pysheet-gokan.ja.md] — all 324 core members of the three libraries, judged one by one (what works, what we will build, what we won't and why).
