...
**`fd33934`(2026-08-10)。** 通信の言葉は向こうの物で、**向こうは誰にも断らずに
変えられます** — こちらは他人の窓口の別実装であって、向こうと何かを取り決めて
いるわけではないからです。だから commit を書き留めてあり、新しい genoffice を
取り込んだら、下の3段をもう一度回してから信用します。

2026-08-10 に入った7つの commit では、向こうの Rust の助手は**1ファイルも
変わりませんでした**。たいていはこうなります — **通信の言葉は、その周りの
アプリよりずっとゆっくり動きます。**
