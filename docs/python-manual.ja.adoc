...
*専用の手引き: link:writer-macro-manual.ja.adoc[writer-macro-manual.ja.adoc]* —名前つき記入欄(`fill` / `extract` / `fields`)、雛形(`render` / `tpl_fields`、docxtpl)、サンドボックスの中身、AI にコードを書かせる話まで。
