...
pub const WRITER: &[Tab] = &[
    ...
    Tab { name: "Home", cmds: &[
        ...
        c("highlight", "Highlight color", "highlight"),
        c("fontcolor", "Font color", "fontcolor"),
    ...
    Tab { name: "Insert", cmds: &[
        ...
        c("pagebreak", "Insert page or section break", "pagebreak"),
        ...
        c("smartpicker", "Insert chart", "smartpicker"),
    ...
    Tab { name: "Layout", cmds: &[
        ...
        c("pagecolor", "Change page color", "pagecolor"),
        c("colorschemas", "Change color theme", "colorschemas"),
    ]},
...
pub const CALC: &[Tab] = &[
    ...
    Tab { name: "Home", cmds: &[
        ...
        c("subscript", "Subscript", "subscript"),
        c("fontcolor", "Font color", "fontcolor"),
        c("fillparag", "Fill color", "fillparag"),
        c("borders", "Borders", "borders"),
        c("top", "Align top", "top"),
        c("middle", "Center", "middle"),
        c("bottom", "Align bottom", "bottom"),
        c("wrap", "Wrap text", "wrap"),
        c("text-orient", "Page orientation", "text-orient"),
        c("align-left", "Align left", "align-left"),
        c("align-center", "Center", "align-center"),
        c("align-right", "Align right", "align-right"),
        c("align-just", "Justified", "align-just"),
        ...
        c("cell-format", "Cell Style", "cell-format"),
        c("condformat", "Conditional formatting", "condformat"),
        c("table-tpl", "Insert table", "table-tpl"),
    ...
    Tab { name: "Insert", cmds: &[
        ...
        c("addcomment", "Comment", "ins-comment"),
        c("insrecommend", "Insert chart", "smartpicker"),
    ...
    Tab { name: "Layout", cmds: &[
        ...
        c("printarea-add", "Add to print area", "printarea-add"),
    ...
    Tab { name: "Data", cmds: &[
        ...
        c("flash-fill", "Flash Fill", "flash-fill"),
    ]},
    ...
    Tab { name: "Collaboration", cmds: &[
        c("coauth-mode", "Co-editing mode", "coauth-mode"),
        c("addcomment", "Add Comment", "co-addcomment"),
        c("co-delcomment", "Delete comment", "co-delcomment"),
        c("co-showcomment", "Show comments", "co-showcomment"),
        c("co-chat", "Chat", "co-chat"),
        c("co-history", "Version history", "co-history"),
    ...
    Tab { name: "Protection", cmds: &[
        ...
        c("prot-sign", "Add digital signature", "prot-sign"),
        c("cell-lock", "Lock cell", "cell-lock"),
        c("prot-allow", "Allowed actions", "prot-allow"),
        c("recover", "Recover", "recover"),
        c("recover-every", "Recover every", "recover-every"),
        c("read-only-rec", "Recommend read-only", "read-only-rec"),
    ]},
    Tab { name: "View", cmds: &[
