...
- `writer` — **a visual editor for AsciiDoc**: edit your source (.adoc) as it looks, and put it out as screen, PDF, HTML or docx. docx is the delivery format — you can open one and turn it into adoc ([manual](docs/writer-manual.md))
