...
mod round {
    ...
    fn para(s: &str) -> Paragraph {
        Paragraph { style_id: None, space_before_pt: 0.0, space_after_pt: 0.0,  align: Default::default(), style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, anchors: Vec::new(), sect: None,
    ...
    fn doc(parts: &[&str]) -> Document {
        Document { size_pt: None, note_ids_taken: Vec::new(), template: None, styles: Vec::new(), styles_new: Vec::new(),  footnote_fmt: Default::default(), endnote_fmt: Default::default(), font: None, page: None, sect_raw: None, footnotes: Vec::new(), header: Default::default(), footer: Default::default(), page_color: None, watermark: None, ink: Vec::new(), track_author: None, hyphenate: false, protection: None, props: Default::default(), vertical: false, blocks: parts.iter().map(|s| Block::Para(para(s))).collect() }
    }
    ...
    #[test]
    fn 文字サイズが保たれる() {
        let d = Document { size_pt: None, note_ids_taken: Vec::new(), template: None, styles: Vec::new(), styles_new: Vec::new(),  footnote_fmt: Default::default(), endnote_fmt: Default::default(), font: None, page: None, sect_raw: None, footnotes: Vec::new(), header: Default::default(), footer: Default::default(), page_color: None, watermark: None, ink: Vec::new(), track_author: None, hyphenate: false, protection: None, props: Default::default(), vertical: false, blocks: vec![Block::Para(Paragraph { style_id: None, space_before_pt: 0.0, space_after_pt: 0.0,  align: Default::default(), style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, anchors: Vec::new(), sect: None,
                    images: Vec::new(), page_break_before: false,
...
mod font_tests {
    ...
    fn 書体名が往復する() {
        ...
        let doc = Document { size_pt: None, note_ids_taken: Vec::new(), template: None, styles: Vec::new(), styles_new: Vec::new(),  footnote_fmt: Default::default(), endnote_fmt: Default::default(), footnotes: Vec::new(),
            font: None,
            page: None,
            ...
            blocks: vec![Block::Para(Paragraph { style_id: None, space_before_pt: 0.0, space_after_pt: 0.0,  style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, sect: None,
...
mod fmt_tests {
    ...
    fn 太字と斜体と下線が往復する() {
        ...
        let d = Document { size_pt: None, note_ids_taken: Vec::new(), template: None, styles: Vec::new(), styles_new: Vec::new(),  footnote_fmt: Default::default(), endnote_fmt: Default::default(), footnotes: Vec::new(),
            font: None,
            page: None,
            sect_raw: None, header: Default::default(), footer: Default::default(), page_color: None, watermark: None, ink: Vec::new(), track_author: None, hyphenate: false, protection: None, props: Default::default(), vertical: false,
            blocks: vec![Block::Para(Paragraph { style_id: None, space_before_pt: 0.0, space_after_pt: 0.0,  align: Align::Left, style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, anchors: Vec::new(), sect: None,
                    images: Vec::new(), page_break_before: false,
...
mod para_tests {
    ...
    fn para(list: ListKind, indent: u8, spacing: f32) -> Paragraph {
        Paragraph { style_id: None, space_before_pt: 0.0, space_after_pt: 0.0,  style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, sect: None,
            align: Align::Left,
            anchors: Vec::new(),
                    images: Vec::new(),
            page_break_before: false,
...
/// **段落の前後の空きが往復で消えない**(2026-08-15)。
    ...
    #[test]
    fn 段落の前後の空きが往復する() {
        let mut p = Paragraph { style_id: None, space_before_pt: 12.0, space_after_pt: 6.0,
    ...
    #[test]
    fn 空きの無い段落は素のまま() {
        let p = Paragraph { style_id: None, space_before_pt: 0.0, space_after_pt: 0.0,
            align: Default::default(), style: Default::default(), comments: Vec::new(),
            bookmarks: Vec::new(), anchors: Vec::new(), sect: None, images: Vec::new(),
            page_break_before: false, list: ListKind::None, indent: 0, first_line_twips: 0,
            line_spacing: 1.0, shade: None, boxed: false, dropcap: false,
...
mod vertalign_tests {
    ...
    fn doc_with(fmt: CharFormat) -> Document {
        Document { size_pt: None, note_ids_taken: Vec::new(), template: None, styles: Vec::new(), styles_new: Vec::new(),  footnote_fmt: Default::default(), endnote_fmt: Default::default(), footnotes: Vec::new(),
            font: None,
            page: None,
            sect_raw: None, header: Default::default(), footer: Default::default(), page_color: None, watermark: None, ink: Vec::new(), track_author: None, hyphenate: false, protection: None, props: Default::default(), vertical: false,
