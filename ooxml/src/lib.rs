...
pub use read::{foreign_shape, foreign_shape_with, foreign_shapes_in, shape_has_picture_fill, ink_anchor_run, ink_anchor_xml, shape_anchor_run, shape_anchor_xml, parse_document_with, parse_document_xml, read, ForeignShape, Report};
pub use write::{
