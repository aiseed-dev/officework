...
def main(page: ft.Page):
    ...
    why = section(
        ...
        p("Microsoft 365 は逆です。AI が要らない人にも Copilot を付けて、その分の料金を取ります。"
          "2026 年 7 月から法人向けの基本の料金に Copilot Chat が入って値上げになり、"
          "個人向けは Copilot 入りが既定で、無しの Classic は自分で探して選ぶ形です。"
          "aiseed office は、AI が要らない所には何も付けません。", 15),
