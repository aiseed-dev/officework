...
impl Render for Calc {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        const BIG: &[(&str, &str)] = &[
            ...
            ("coauth-mode", "モード"), ("co-addcomment", "コメント"),
            ("co-chat", "チャット"), ("co-history", "履歴"),
        ...
        const SHORT: &[(&str, &str)] = &[
            ...
            ("data-from-text", "テキスト"), ("data-external-links", "リンク編集"),
            ...
            ("rem-duplicates", "重複削除"), ("td-torange", "範囲へ"),
