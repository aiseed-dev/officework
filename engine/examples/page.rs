...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let doc = Document { footnotes: Vec::new(), footnote_fmt: Default::default(), endnote_fmt: Default::default(),
        font: None,
        page: None,
        ...
        blocks: vec![
            Block::Para(Paragraph { align: Default::default(), style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, anchors: Vec::new(), sect: None,
