...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let doc = Document { theme_colors: Vec::new(), space_after_pt: None, line_spacing: None, note_ids_taken: Vec::new(), template: None, attrs: Vec::new(), styles: Vec::new(), styles_new: Vec::new(),  footnotes: Vec::new(), footnote_fmt: Default::default(), endnote_fmt: Default::default(),
        ...
        size_pt: None,
        page: None,
        sect_raw: None, header: Default::default(), footer: Default::default(), page_color: None, watermark: None, ink: Vec::new(), shapes: Vec::new(), track_author: None, hyphenate: false, compress_punct: false, protection: None, props: Default::default(), vertical: false,
        blocks: vec![
