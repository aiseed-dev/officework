...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let doc = Document { no_html_auto_space: false, theme_colors: Vec::new(), space_after_pt: None, line_spacing: None, note_ids_taken: Vec::new(), template: None, attrs: Vec::new(), styles: Vec::new(), styles_new: Vec::new(),  footnotes: Vec::new(), footnote_fmt: Default::default(), endnote_fmt: Default::default(),
        font: None,
        size_pt: None,
        page: None,
