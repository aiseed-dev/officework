...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let doc = Document { note_ids_taken: Vec::new(), template: None, styles: Vec::new(), styles_new: Vec::new(),  footnotes: Vec::new(), footnote_fmt: Default::default(), endnote_fmt: Default::default(),
        font: None,
        size_pt: None,
        page: None,
        ...
        blocks: vec![
            Block::Para(Paragraph { style_id: None, space_before_pt: 0.0, space_after_pt: 0.0,  align: Default::default(), style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, anchors: Vec::new(), sect: None,
