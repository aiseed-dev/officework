    ...
    let doc = Document { note_ids_taken: Vec::new(), template: None, attrs: Vec::new(), styles: Vec::new(), styles_new: Vec::new(),  footnotes: Vec::new(), footnote_fmt: Default::default(), endnote_fmt: Default::default(),
        ...
        blocks: vec![
            Block::Para(Paragraph { style_id: None, raw_adoc: None, list_text: None, space_before_pt: 0.0, space_after_pt: 0.0,  align: Default::default(), style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, anchors: Vec::new(), sect: None,
                    ...
                    list: Default::default(), indent: 0, left_twips: 0, first_line_twips: 0, line_spacing: 1.0, line_pt: None, shade: None, boxed: false, images_new: Vec::new(), runs: vec![Run {
                fmt: Default::default(),
                font: None,
                text: "Japanese-Office 組版エンジン(K0)".into(), size_pt: Some(16.0) }] }),
            Block::Para(Paragraph { style_id: None, raw_adoc: None, list_text: None, space_before_pt: 0.0, space_after_pt: 0.0,  align: Default::default(), style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, anchors: Vec::new(), sect: None,
                    images: Vec::new(), page_break_before: false,
                    list: Default::default(), indent: 0, left_twips: 0, first_line_twips: 0, line_spacing: 1.0, line_pt: None, shade: None, boxed: false, images_new: Vec::new(), runs: vec![Run { font: None, fmt: Default::default(), text: "".into(), size_pt: Some(10.5) }] }),
            Block::Para(Paragraph { style_id: None, raw_adoc: None, list_text: None, space_before_pt: 0.0, space_after_pt: 0.0,  align: Default::default(), style: Default::default(), comments: Vec::new(), bookmarks: Vec::new(), dropcap: false, anchors: Vec::new(), sect: None,
                    images: Vec::new(), page_break_before: false,
                    list: Default::default(), indent: 0, left_twips: 0, first_line_twips: 0, line_spacing: 1.0, line_pt: None, shade: None, boxed: false, images_new: Vec::new(), runs: vec![Run { font: None, fmt: Default::default(), text:
