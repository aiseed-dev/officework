...
pub const WORDS: &[(&str, [&str; 15])] = &[
    ...
    ("title_rows", ["Titelzeile", "Title rows", "Fila de título", "Ligne du titre", "Baris judul", "Riga del titolo", "タイトル行", "제목 행", "Linha de título", "Linha de título", "Заглавная строка", "Başlık satırı", "Title rows", "标题行", "題名列"]),
    ...
    ("medium", ["Mittel", "Medium", "media", "Medium", "sedang", "medio", "中", "중간 굵기", "Média", "Média", "Средняя", "Orta kalın", "Nét", "中粗", "中粗"]),
