...
///
/// `Sheet` に持ち物を足したとき [`crate::book::holes::WATCHED`] に足し忘れると、
/// その持ち物は落ちても誰も何も言いません。**穴を数える道具に穴が空く**ので、
/// ここで機械に照合させます。
#[cfg(test)]
mod holes_watch {
    use crate::book::holes::{WATCHED, WATCHED_BOOK};
...
#[cfg(test)]
mod holes_count {
    use crate::book::holes::round_trip_holes;
